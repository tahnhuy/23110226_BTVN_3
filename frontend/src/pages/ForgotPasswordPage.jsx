        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 px-4 py-12">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-sm text-slate-600">Khôi phục quyền truy cập vào tài khoản của bạn</p>
                </div>
                        ...
                        {!forgotPasswordSuccess ? (
                            <form onSubmit={handleSendOtp} className="space-y-4">
                                <p className="text-sm text-slate-600 mb-2">
                                    Vui lòng nhập địa chỉ email bạn đã dùng để đăng ký. Chúng tôi sẽ gửi một mã OTP để xác nhận.
                                </p>
                                <InputField
                                    label="Email của bạn"
                                    name="email"
                                ...
                                />
                                <div className="pt-2">
                                    <Button type="submit" variant="primary" className="w-full" isLoading={forgotPasswordLoading} disabled={cooldown > 0}>
                            ...
                            <form onSubmit={handleResetPassword} className="space-y-4">
                                <div className="bg-blue-50 text-blue-800 p-3 rounded-lg text-sm mb-4 border border-blue-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                    <span>Mã xác nhận đã gửi đến <strong>{email}</strong>!</span>
                                    <button 
                                        type="button" 
                                ...
                                <div className="pt-2">
                                    <Button type="submit" variant="primary" className="w-full" isLoading={resetPasswordLoading}>
